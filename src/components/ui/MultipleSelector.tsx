  ...
  (
    ...
    return (
      <Command
        ...
        className={`overflow-visible  ${commandProps?.className}`}
      ...
      >
        ...
        >
          <div className="flex flex-wrap gap-1">
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={`ml-1 h-full py-0 px-2 rounded-none rounded-tr-lg rounded-br-lg hover:bg-def-400 outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2 ${
            ...
            <CommandPrimitive.Input
              ...
              className={`flex-1 bg-transparent outline-none w-full min-w-96 h-8 ps-1 text-def-100 placeholder:text-muted-foreground ${
        ...
        <div className="relative mt-2 ">
          {open && (
            <CommandList className="absolute top-0 z-10 w-full rounded-md border text-popover-foreground shadow-md outline-none animate-in">
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
                  ...
                  {Object.entries(selectables).map(([key, dropdowns]) => (
                    <CommandGroup key={key} heading={key} className="h-full overflow-visible ">
                      <>
                        {dropdowns.map((option) => {
                          return (
                            <CommandItem
                              ...
                              className={`cursor-pointer ${option.disable && "cursor-default text-muted-foreground"}`}
                            >
                              {option.label}
                            </CommandItem>
                          );
